...
import { saveLibraryResource, deleteLibraryResource, subscribeToAnnouncement, updateAnnouncement, addAdmin, removeAdmin, getAdmins } from '../services/firestoreService';
...
const AdminPage: React.FC<AdminPageProps> = ({ onBack, libraryResources }) => {
    const [activeTab, setActiveTab] = useState<'library' | 'announcements' | 'admins'>('library');
    ...
    const handleSaveResource = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const resourceToSave: any = {
                ...
                category: resourceFormData.category || 'Physics',
